...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/" element={<ProtectedRoute><DashboardLayout /></ProtectedRoute>}>
      ...
      {/* HR */}
      <Route path="hr" element={<RoleGuard roles={['hr', 'admin']}><HRDashboard /></RoleGuard>} />
      <Route path="hr/schedule" element={<RoleGuard roles={['hr', 'admin']}><ScheduleInterviewPage /></RoleGuard>} />

      {/* Interviewer */}
      <Route path="interviewer" element={<RoleGuard roles={['interviewer']}><InterviewerDashboard /></RoleGuard>} />

      {/* Candidate */}
      <Route path="candidate" element={<RoleGuard roles={['candidate']}><CandidateDashboard /></RoleGuard>} />
    ...
    <Route path="/room/:id" element={<ProtectedRoute><InterviewRoomPage /></ProtectedRoute>} />
